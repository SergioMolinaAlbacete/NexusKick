...
$sql = "UPDATE ficha_tecnica SET posicion_habitual = ?, posicion_secundaria = ?, estilo_de_juego = ?, notas_adicionales = ? WHERE usuario_id = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("ssssi", $posicion_habitual, $posicion_secundaria, $estilo_de_juego, $notas_adicionales, $usuario_id);
$stmt->execute();
